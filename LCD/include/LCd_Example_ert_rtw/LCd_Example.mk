###########################################################################
## Makefile generated for Simulink model 'LCd_Example'. 
## 
## Makefile     : LCd_Example.mk
## Generated on : Tue Jan 07 16:22:33 2020
## MATLAB Coder version: 4.3 (R2019b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/LCd_Example.elf
...
PRODUCT_NAME              = LCd_Example
MAKEFILE                  = LCd_Example.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2019b
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2019b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/ganna/OneDrive/Desktop/ROBOHO~1/ROBOHO~1/LCD/include
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/LCd_Example.elf
...
DEFINES_STANDARD = -DMODEL=LCd_Example -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.o : $(START_DIR)/LCd_Example_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/LCd_Example_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/LCd_Example_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
LCD_sim.o : C:/Users/ganna/OneDrive/Desktop/ROBOHO~1/ROBOHO~1/LCD/src/LCD_sim.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


LiquidCrystal_I2C.o : $(START_DIR)/LiquidCrystal_I2C.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


LCd_Example.o : $(START_DIR)/LCd_Example_ert_rtw/LCd_Example.c
	$(CC) $(CFLAGS) -o "$@" "$<"


LCd_Example_data.o : $(START_DIR)/LCd_Example_ert_rtw/LCd_Example_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/LCd_Example_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
